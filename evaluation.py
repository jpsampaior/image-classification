...
def generate_confusion_matrix_sklearn(actual_labels, predicted_labels, model_name=None):
    ...
    display_cm = ConfusionMatrixDisplay(confusion_matrix=cm,
                                        display_labels=["airplane", "automobile", "bird", "cat", "deer", "dog", "frog",
                                                        "horse", "ship", "truck"])
    display_cm.plot()
    if model_name:
...
def generate_confusion_matrix_custom(actual_labels, predicted_labels, model_name=None):
    ...
    print(result)
    print("Legend\n")
    print("Row Indecies from 0-9: ", "airplane=0", "automobile=1", "bird=2", "cat=3", "deer=4", "dog=5", "frog=6",
          "horse=7", "ship=8", "truck=9")
    print("Column Indecies from 0-9: ", "airplane=0", "automobile=1", "bird=2", "cat=3", "deer=4", "dog=5", "frog=6",
          "horse=7", "ship=8", "truck=9")
